...
public class eHDDPpacket extends BasePacket {
     ...
     * @return objeto de la clase eHDDPpacket
     */
    public eHDDPpacket(byte[] Mac_ant, byte[] Last_mac, byte[] Src_mac, byte Opcode, byte Num_hops, int Time_block, long Num_Sec, long Num_ack,
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof eHDDPpacket)) {
            return false;
        }
        final eHDDPpacket other = (eHDDPpacket) obj;
    ...
    public static Deserializer<eHDDPpacket> deserializer() {
        return (data, offset, length) -> {

            checkInput(data, offset, length, 61);
            final ByteBuffer bb = ByteBuffer.wrap(data, offset, length);
            /** Creamos la clase para ser rellenada */
            eHDDPpacket packet = new eHDDPpacket();
            /** Sacamos el primer byte (Flags and Version) */
            BitSet aux_BitSet = BitSet.valueOf(new byte[] { bb.get() });
    ...
    public String toString() {
        return toStringHelper(getClass())
                ...
                .add("MAC_Ant", Arrays.toString(this.Mac_ant))
                .add("Num Ack", String.valueOf(this.Num_Ack))
                .add("Lst_MAC", Arrays.toString(this.Last_mac))
                .add("Scr_Mac", Arrays.toString(this.Src_mac))
...
//        @SuppressWarnings("ArrayToString")
        ...
        return Arrays.toString(addressInBytes);
