...
uint32_t  oxm_ids[]={OXM_OF_IN_PORT,OXM_OF_IN_PHY_PORT,OXM_OF_METADATA,OXM_OF_ETH_DST,
                        ...
                        OXM_OF_EHDDP_FLAGS, OXM_OF_EHDDP_OPCODE, OXM_OF_EHDDP_NUM_DEVICE, OXM_OF_EHDDP_NUM_SEC,
                        OXM_OF_EHDDP_PRE_MAC_SIZ, OXM_OF_EHDDP_PRE_MAC, OXM_OF_EHDDP_NUM_ACK, OXM_OF_EHDDP_SRC_MAC,
                        OXM_OF_EHDDP_LAS_MAC, OXM_OF_EHDDP_TIM_BLO, OXM_OF_EHDDP_CONFIG, 
                        OXM_OF_EHDDP_TYPE_DEVICE, OXM_OF_EHDDP_IDS, OXM_OF_EHDDP_IN_PORTS, OXM_OF_EHDDP_OUT_PORTS
