...
void 
ofl_structs_match_put_macs(struct ofl_match *match, uint32_t header, uint64_t *  value);

void 
ofl_structs_match_put_port(struct ofl_match *match, uint32_t header, uint32_t *  value);
