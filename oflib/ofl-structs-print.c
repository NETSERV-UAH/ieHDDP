...
/*JAH-UAH MDP Printing macros*/
#define DHT                                                    \
    "%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 \
   ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 \
   ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 \
   ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8 ":%02" PRIx8
#define DHT_PREFIX(prfx)																						\
	(prfx)[0], (prfx)[1], (prfx)[2], (prfx)[3], (prfx)[4], (prfx)[5], (prfx)[6], (prfx)[7], \
	(prfx)[8], (prfx)[9], (prfx)[10], (prfx)[11], (prfx)[12], (prfx)[13], (prfx)[14], (prfx)[15], \
	(prfx)[16], (prfx)[17], (prfx)[18], (prfx)[19], (prfx)[20], (prfx)[21], (prfx)[22], (prfx)[23], \
	(prfx)[24], (prfx)[25], (prfx)[26], (prfx)[27]
...
ofl_structs_oxm_tlv_print(FILE *stream, struct ofl_match_tlv *f)
{
	...
	switch (field) {
        ...
        case OFPXMT_OFB_EHDDP_FLAGS:
            fprintf(stream,"Flags and version: \"%"PRIu8"\"",*((uint8_t*)(f->value)));
            break;
	    case OFPXMT_OFB_EHDDP_OPCODE:
            fprintf(stream,"OpCode: \"%"PRIu8"\"",*((uint8_t*)(f->value)));
            break;
        case OFPXMT_OFB_EHDDP_NUM_DEVICE:
            fprintf(stream,"Number of Devices: \"%"PRIu8"\"",*((uint8_t*)(f->value)));
            break;
        case OFPXMT_OFB_EHDDP_NUM_SEC:
            fprintf(stream,"Num Secuence: \"%"PRIu64"\"",*((uint64_t*)(f->value)));
            break;
        case OFPXMT_OFB_EHDDP_PRE_MAC_SIZ:
            fprintf(stream,"Previous MAC Size: \"%"PRIu8"\"",*((uint8_t*)(f->value)));
            break;
        case OFPXMT_OFB_EHDDP_PRE_MAC:
            fprintf(stream,"Previous MAC: \"%"PRIu64"\"",*((uint64_t*)(f->value)));
            break;
        case OFPXMT_OFB_EHDDP_NUM_ACK:
            fprintf(stream,"Num ACK: \"%"PRIu64"\"",*((uint64_t*)(f->value)));
            break;
        case OFPXMT_OFB_EHDDP_SRC_MAC:
            fprintf(stream,"SOURCE MAC: \"%"PRIu64"\"",*((uint64_t*)(f->value)));
            break;
        case OFPXMT_OFB_EHDDP_LAS_MAC:
            fprintf(stream,"LAST MAC: \"%"PRIu64"\"",*((uint64_t*)(f->value)));
            break;
        ...
        case OFPXMT_OFB_EHDDP_CONFIG:
            ...
            fprintf(stream,"PORTS LEN: \"%"PRIu8"\"",*((uint8_t*)(f->value)) & 0b00000110);
            fprintf(stream,"BIDIRECTIONAL: \"%"PRIu8"\"",*((uint8_t*)(f->value)) & 0b00000001);
            break;    
        case OFPXMT_OFB_EHDDP_TYPE_DEVICE:
            fprintf(stream,"Type of Device: \"%"PRIu16"\"",*((uint16_t*)(f->value)));
            break;
        case OFPXMT_OFB_EHDDP_IDS:
            fprintf(stream,"IDS: \"%"PRIu64"\"",*((uint64_t*)(f->value)));           
            break;
        case OFPXMT_OFB_EHDDP_IN_PORTS:
            fprintf(stream,"InPortsList: \"%"PRIu32"\"",*((uint32_t*)(f->value)));
            break;
